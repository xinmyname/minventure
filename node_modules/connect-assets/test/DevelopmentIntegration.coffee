...
exports['Raw CSS is served directly'] = (test) ->
  cssTag = '<link rel="stylesheet" href="/assets/css/normalize.css" />'<link rel="stylesheet" href="/css/normalize.css" />'
...
exports['CSS with data: uris are okay'] = (test) ->
  cssTag = '<link rel="stylesheet" href="/assets/css/data-uri.css" />'<link rel="stylesheet" href="/css/data-uri.css" />'
  errFn = console.error;
...
exports['Stylus is served as CSS'] = (test) ->
  cssTag = '<link rel="stylesheet" href="/assets/css/style.css" />'<link rel="stylesheet" href="/css/style.css" />'
...
exports['Stylus imports work as expected'] = (test) ->
  cssTag = '<link rel="stylesheet" href="/assets/css/button.css" />'<link rel="stylesheet" href="/css/button.css" />'
...
exports['Stylus provides the assetsurl function'] = (test) ->
  cssTag = '<link rel="stylesheet" href="/assets/css/background-styl.css" />'<link rel="stylesheet" href="/css/background-styl.css" />'
...
exports['Less is served as CSS'] = (test) ->
  cssTag = '<link rel="stylesheet" href="/assets/css/style-less.css" />'<link rel="stylesheet" href="/css/style-less.css" />'
...
exports['Less provides the assetsurl function'] = (test) ->
  cssTag = '<link rel="stylesheet" href="/assets/css/background-less.css" />'<link rel="stylesheet" href="/css/background-less.css" />'
...
exports['nib is supported when available'] = (test) ->
  cssTag = '<link rel="stylesheet" href="/assets/css/gradient.css" />'<link rel="stylesheet" href="/css/gradient.css" />'
...
exports['css helper function allows media tag'] = (test) ->
  cssTag = '<link rel="stylesheet" href="/assets/css/style.css" media="print" />'<link rel="stylesheet" href="/css/style.css" media="print" />'
