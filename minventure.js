...
(function() {
  var City, Encounter, Fighting, GameState, Location, Loot, LootFactory, Monster, Moving, PlayerState, Resting, Ruins, Town, encounterChance, encounters, gameOver, gameState, gameTick, lootFactory, moveToNextEncounter, playerStates, startGame, statusLines, stopGame, updateStatus, _ref,
  ...
  Loot = (function() {
    ...
    Loot.constructor = function(id, description, quantity) {
      this.id = id;
