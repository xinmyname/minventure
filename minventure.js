...
(function() {
  var Buying, City, Encounter, EncounterChance, Fighting, GameState, Location, Monster, Moving, PlayerState, Resting, Selling, Town, encounterChance, encounters, gameState, moveToNextEncounter, playerStates, setInterval, timerId, _ref,
  ...
  Monster = (function(_super) {
    ...
    Monster.prototype.action = function() {
      ...
      damage = 1;
      return gameState.setHealth(gameState.health - damage);
    };
